...
PADDING_BOUTON = 20
PADDING_BOUTON_ECRAN = 30
COULEUR_BOUTON = (0, 0, 0)  #couleur des bontons a l'intèrieur

#bouton sauvegarde
TAILLE_BOUTON_SAUVEGARDE = (60, 30)
POSITION_BOUTON_SAUVEGARDE = (LIMITEX_ECHIQUIER + PADDING_BOUTON_ECRAN, LIMITEY_ECHIQUIER-TAILLE_BOUTON_SAUVEGARDE[1])

#bouton retour arriere
TAILLE_BOUTON_ARRIERE = (20, 10)
POSITION_BOUTON_ARRIERE = (POSITION_BOUTON_SAUVEGARDE[0], POSITION_BOUTON_SAUVEGARDE[1] - TAILLE_BOUTON_ARRIERE[1] - PADDING_BOUTON)

#bouton retour arriere
TAILLE_BOUTON_AVANT = (20, 10)
POSITION_BOUTON_AVANT = (POSITION_BOUTON_ARRIERE[0], POSITION_BOUTON_ARRIERE[1] - TAILLE_BOUTON_AVANT[1] - PADDING_BOUTON)
